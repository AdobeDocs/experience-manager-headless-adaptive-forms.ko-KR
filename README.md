...
Adobe 커뮤니티에 소속되어 있고 새 문서를 만들거나 주요 변경 사항을 제안하려는 경우 Git 저장소의 **문제** 탭에서 문제를 여십시오. 이렇게 하면 설명서 팀과 대화가 시작됩니다. 플랜에 동의하면 직원과 협력하여 공용 및 개인 저장소에서 작업을 결합하여 새 콘텐츠를 가져올 수 있도록 해야 합니다.
...
Experience Cloud 기술 문서를 만들거나 업데이트하는 기술 작가, 프로그램 관리자 및 제품 팀 개발자는 `https://git.corp.adobe.com/AdobeDocs`의 개인 저장소를 사용해야 합니다.

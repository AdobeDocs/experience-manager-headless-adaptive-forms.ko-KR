...
개방적이고 환영하는 환경을 조성하기 위해, 기여자 및 유지 관리자는 프로젝트 및 커뮤니티에 괴롭힘 없는 경험이 되도록 서약합니다. 이러한 헌신은 연령, 신체 사이즈, 장애, 민족성, 성 정체성 및 표현에 관계없이 모든 사람에게 적용됩니다. 경험 수준, 국적, 외모, 인종, 종교, 성적 정체성 및 취향과 관계가 없습니다.
...
학대, 괴롭힘 또는 다른 용납할 수 없는 행동이 발생하는 경우 프로젝트 팀(Grp-opensourceoffice@adobe.com)에 문의하여 보고할 수 있습니다. 모두
불만 사항은 검토 및 조사되며 다음과 같은 결과를 초래할 수 있습니다.
상황에 따라 필요하고 적절한 것으로 간주됩니다. 해당 프로젝트 팀은 사건의 신고자와 관련하여 기밀을 유지해야 합니다.
